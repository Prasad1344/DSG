...
class Venue : NSObject, NSCoding{
	...
	init(fromDictionary dictionary: [String:Any]){
		...
		displayLocation = dictionary["display_location"] as? String
		extendedAddress = dictionary["extended_address"] as? String
		...
		metroCode = dictionary["metro_code"] as? Int
		name = dictionary["name"] as? String
		nameV2 = dictionary["name_v2"] as? String
		numUpcomingEvents = dictionary["num_upcoming_events"] as? Int
		popularity = dictionary["popularity"] as? Int
		postalCode = dictionary["postal_code"] as? String
